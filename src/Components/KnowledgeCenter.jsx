        ...
        <div className="bg-gray-50 min-h-screen font-sans text-gray-800">
            ...
            <section className="text-center py-20 bg-gradient-to-r from-blue-600 to-teal-500 text-white">
                ...
                <p className="text-lg max-w-2xl mx-auto opacity-90">
                    Learn directly from our doctors and discover health insights through
                    articles, blogs, and videos — all in one place.
                </p>
            </section>
            ...
            <section className="bg-white py-16">
                ...
                <p className="text-center text-gray-600 mb-10">
                    Watch expert talks, patient stories, and treatment insights right
                    here.
                </p>
            ...
            <section className="py-16 text-center bg-gradient-to-br from-blue-50 to-white">
                ...
                <p className="text-gray-600 mb-8">
                    Subscribe to get weekly updates, blogs, and health tips from our
                    experts.
                </p>
